# 0.5.3 compatibility fixtures

Generated from world tag v0.5.3 (fd011f3b), contract 13db0b3a, using AP 0.6.7
...
To reproduce, install the unmodified v0.5.3 world into an isolated AP checkout,
...
The classes own the exact options. Both keep all regions and emit 4,909 locations,
...
0.5.3; profile already has a legacy selector, and the other two are optional.

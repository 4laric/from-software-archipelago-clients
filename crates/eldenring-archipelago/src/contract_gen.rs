...
pub const CONTRACT: &[ContractKey] = &[
    ...
    ContractKey { name: "abilityUnlockItems", shape: Shape::StrMap, required: false, greenfield: true },
    ...
    ContractKey { name: "scaduBlessingCap", shape: Shape::Int, required: false, greenfield: true },
    ...
    ContractKey { name: "capitalWorldBurnFlag", shape: Shape::Int, required: false, greenfield: true },
    ContractKey { name: "capitalPreBurnFlag", shape: Shape::Int, required: false, greenfield: true },
    ContractKey { name: "capitalReleaseRows", shape: Shape::TripleList, required: false, greenfield: true },
    ContractKey { name: "graceAttunement", shape: Shape::Any, required: false, greenfield: true },
    ...
    ContractKey { name: "revealSweepBossNames", shape: Shape::Bool, required: false, greenfield: true },
    ...
    ContractKey { name: "checkLotZeroMap", shape: Shape::ListvalIntMap, required: false, greenfield: true },
...
pub const CONTRACT_HASH: &str = "6b93d721";
